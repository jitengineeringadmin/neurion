...
export default function ModelsPage() {
  ...
  return (
    <div style={{ maxWidth: 880 }}>
      ...
      {/* Everything below belongs to ollama, which Neurion no longer needs and
          most machines do not have. Shown only when ollama is genuinely
          running: an empty "installed" list sitting under a page that already
          lists three working models does not read as "ollama has none", it
          reads as broken. */}
      {engine === "up" && (
        <>
        <h3
        ...
        >
          {t("models.installedOllamaHeading")}
        </h3>
        {memory && (
          <div
            style={{
