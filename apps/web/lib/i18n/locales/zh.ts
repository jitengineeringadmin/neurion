...
const dict: Record<string, string> = {
  ...
  "image.model": "模型",
  "image.chooseModel": "选择模型",
  "image.customFile": "使用我自己的文件…",
  "image.recommended": "推荐",

  "ob.title": "欢迎使用 Neurion",
  "ob.sub": "你的 AI，在你自己的电脑上——需要更强算力时，还有共享网络助力。",
  "ob.b1": "与运行在你电脑上的 AI 模型聊天",
  "ob.b2": "在本地生成图像",
  "ob.b3": "共享闲置算力，赚取积分",
  "ob.next": "开始",
  "ob.skip": "跳过",
  ...
  "ob.modelBtn": "下载推荐模型",
  "ob.doneTitle": "一切就绪！",
  "ob.doneBody": "想问什么就问——全部在你的电脑上运行。",
  "ob.doneBtn": "开始聊天",
  "agent.details": "详情",
  "agent.t.read_file": "正在读取 {v}",
  "agent.t.write_file": "正在写入 {v}",
  "agent.t.edit_file": "正在编辑 {v}",
  "agent.t.apply_patch": "正在更新 {v}",
  "agent.t.rollback_patch": "正在回滚更改 {v}",
  "agent.t.project_map": "正在索引项目",
  "agent.t.code_search": "正在搜索代码 {v}",
  "agent.t.symbol_graph": "正在分析符号 {v}",
  "agent.t.verify_project": "正在验证项目",
  "agent.t.run_command": "正在执行：{v}",
  "agent.t.start_process": "正在启动进程：{v}",
  "agent.t.read_process": "正在读取进程 {v}",
  "agent.t.wait_process": "正在等待进程 {v}",
  "agent.t.stop_process": "正在停止进程 {v}",
  "agent.reviewing": "正在审查已验证的更改...",
  "agent.reviewPass": "独立审查已通过",
  "agent.reviewChanges": "独立审查要求修改",
  ...
  "audio.moodHappy": "欢快",
  "audio.moodDark": "黑暗",
  "audio.voicePlaceholder": "配音内容（留空 = 使用提示词）",
  "audio.genPlaceholder": "描述音乐（留空 = 使用提示词）",
  "audio.genNote": "在你的 CPU 上生成——需额外几分钟。实验性。",
  "audio.setupMusic": "下载音乐包（约25 MB，一次性）",
  "audio.setupTts": "下载语音（约80 MB，一次性）",
  ...
  "models.engineUpBundled": "运行中（Neurion 引擎）",
  "models.useLocalFile": "使用我已有的模型",
  "models.needsOllama":
    "该目录通过 ollama 下载，而 ollama 未在运行。请使用上方 Neurion 自带的引擎，或使用你已有的模型。",
  "models.localFileTitle": "使用本机文件夹中的模型",
  "models.localFileBody":
    "已经有 .gguf 文件了？把路径告诉 Neurion，它就在原位运行——不复制，也不重新下载。",
  ...
  "models.neurionCatalogTitle": "Neurion 自带模型",
  "models.neurionCatalogBody":
    "由 Neurion 自行下载并运行，无需安装其他任何程序。",
