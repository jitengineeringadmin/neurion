...
const dict: Record<string, string> = {
  ...
  "models.installedOllamaHeading": "已装入 ollama",
  ...
  "models.uploadLimits": "同时最多 {n} 份，上限 {r}",
  "models.blockedCount": "已忽略 {n} 个",
  "models.reachAsk": "要让家庭网络之外的人也能连到这台电脑吗？Neurion 会请你的路由器打开一个端口。不打开也没关系：在本网络内以及对已有你地址的人，共享照常工作。",
  "models.reachYes": "打开端口",
  "models.reachNo": "不用了",
  "models.blockConfirm": "不再与 {a} 通信？不会向它提供任何内容，也不会向它请求任何内容。",
  "models.blockPeer": "忽略",
