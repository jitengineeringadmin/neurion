...
const dict: Record<string, string> = {
  ...
  "models.uploadLimits": "не больше {n} копий одновременно, до {r}",
  "models.blockedCount": "{n} игнорируются",
  "models.reachAsk": "Разрешить другим людям обращаться к этому компьютеру извне вашей домашней сети? Neurion попросит роутер открыть один порт. Без этого обмен всё равно работает в этой сети и с теми, у кого уже есть ваш адрес.",
  "models.reachYes": "открыть порт",
  "models.reachNo": "нет, спасибо",
  "models.blockConfirm": "Перестать общаться с {a}? Ему ничего не будет отдаваться и ничего не будет запрашиваться.",
  "models.blockPeer": "игнорировать",
