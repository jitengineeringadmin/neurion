...
const dict: Record<string, string> = {
  ...
  "login.startingUpHint": "Приложение запускается — это займёт несколько секунд.",
  "login.startingUpSlow": "Первый запуск может занять до минуты (запуск базы данных)…",
  "nav.tabChat": "Чат",
  "nav.tabAgent": "Code",
  ...
  "ob.autoRec": "выбрано для вашего ПК",
};
export default dict;
