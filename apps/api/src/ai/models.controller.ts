...
const RECOMMENDED = [
  ...
  },
  {
    ...
    label: "Qwen 2.5 3B",
    size: "~1.9 GB",
    note: "Best all-round small model",
    group: "Qwen 2.5",
  },
  {
    name: "qwen2.5:7b",
    label: "Qwen 2.5 7B",
    size: "~4.7 GB",
    note: "Strong, needs 8 GB+ RAM/VRAM",
    group: "Qwen 2.5",
  },
  {
    name: "qwen2.5:14b",
  ...
  },
  {
    ...
    size: "~19 GB",
    note: "Mixture-of-experts, fast for its size",
    group: "Qwen 3",
  },
  {
    name: "qwen3:32b",
  ...
  // DeepSeek R1 — reasoning (thinks step by step; great for hard problems, math, logic)
  {
    ...
    size: "~1.1 GB",
    note: "Reasoning, tiny",
    group: "DeepSeek R1 · reasoning",
  },
  {
    name: "deepseek-r1:7b",
    label: "DeepSeek R1 7B",
    size: "~4.7 GB",
    note: "Reasoning, balanced",
    group: "DeepSeek R1 · reasoning",
  },
  {
    name: "deepseek-r1:8b",
  ...
  },
  {
    ...
    size: "~9.0 GB",
    note: "Reasoning, high quality, GPU",
    group: "DeepSeek R1 · reasoning",
  },
  {
  ...
  },
  {
    ...
    label: "QwQ 32B",
    size: "~20 GB",
    note: "Qwen reasoning model, strong GPU",
    group: "DeepSeek R1 · reasoning",
  },
  // Vision — chat that can SEE images you send
  {
    ...
    size: "~1.7 GB",
    note: "Tiny, sees images, runs on anything",
    group: "Vision · sees images",
  },
  {
    name: "llava:7b",
    label: "LLaVA 7B",
    size: "~4.7 GB",
    note: "Describes/answers about images",
    group: "Vision · sees images",
  },
  {
    name: "llava:13b",
    label: "LLaVA 13B",
    size: "~8.0 GB",
    note: "Better vision, needs a GPU",
    group: "Vision · sees images",
  },
  {
    ...
    size: "~7.9 GB",
    note: "Meta vision, high quality, GPU",
    group: "Vision · sees images",
  },
  ...
  },
  {
    ...
    label: "Gemma 3 27B",
    size: "~17 GB",
    note: "Google flagship, strong GPU",
    group: "Gemma 3",
  },
  // Mistral
  {
  ...
  },
  {
    ...
    size: "~7.1 GB",
    note: "Bigger context, high quality",
    group: "Mistral",
  },
  // Other families
  {
  ...
  },
  {
    ...
    label: "Phi 3.5",
    size: "~2.2 GB",
    note: "Microsoft, strong reasoning",
    group: "Other",
  },
  // Newest top picks (verified on ollama)
  {
    name: "qwen3-coder:30b",
    label: "Qwen 3 Coder 30B (MoE)",
    size: "~19 GB",
    note: "Newest top open coder — fast for its size, strong GPU",
    group: "Top coders · newest",
  },
  {
    name: "codestral:22b",
    label: "Codestral 22B",
    size: "~13 GB",
    note: "Mistral code specialist, excellent for code",
    group: "Top coders · newest",
  },
  {
    name: "starcoder2:7b",
    label: "StarCoder2 7B",
    size: "~4.0 GB",
    note: "Code completion, 600+ languages",
    group: "Top coders · newest",
  },
  {
    name: "starcoder2:15b",
    ...
    size: "~9.1 GB",
    note: "Stronger code completion, GPU",
    group: "Top coders · newest",
  },
  {
    name: "phi4:14b",
    label: "Phi 4 14B",
    size: "~9.1 GB",
    note: "Microsoft, excellent reasoning",
    group: "Other",
  },
  {
    ...
    size: "~14 GB",
    note: "High quality all-round, GPU",
    group: "Mistral",
  },
  {
    name: "granite3.3:8b",
  ...
  },
  {
    ...
    label: "Command R7B",
    size: "~5.0 GB",
    note: "Cohere, great for RAG / documents",
    group: "Other",
  },
  {
    name: "minicpm-v:8b",
    label: "MiniCPM-V 8B",
    size: "~5.5 GB",
    note: "Strong vision, sees images",
    group: "Vision · sees images",
  },
  // Embedding — for search / RAG (not for chat)
  {
    ...
    label: "Nomic Embed",
    size: "~0.3 GB",
    note: "For search / document memory",
  ...
  },
  {
    ...
    size: "~0.7 GB",
    note: "Higher-quality search embeddings",
    group: "Embedding · search",
  },
];
...
export class ModelsController {
  constructor(
    ...
    private readonly memory: ModelMemoryService,
  ) {}
  ...
  async models() {
    ...
    return {
      ...
      chatDefault: this.pickDefault(
        models,
        this.config.get<string>("AI_DEFAULT_CHAT_MODEL"),
      ),
      agentDefault: this.pickDefault(
        models,
        this.config.get<string>("AI_AGENT_MODEL"),
      ),
    };
  }
  ...
  async installed() {
    try {
      ...
      const installed = (json.models ?? []).map((m) => ({
        name: m.name,
  ...
  @Get("models/memory-profile")
  memoryProfile(@Query("name") name?: string) {
    return this.memory.profile(name?.trim() || undefined);
  }
  ...
  async pull(@Body() dto: PullDto, @Res() res: Response): Promise<void> {
    ...
    if (quant) {
      ...
      if (!resolved) {
        send("error", {
          message: `quantization ${quant} is not available for ${base}`,
        });
        return void res.end();
      }
      name = resolved;
    ...
    try {
      ...
      if (!r.ok || !r.body) {
        send("error", {
          message: `engine HTTP ${r.status} — is the model name correct?`,
        });
        return void res.end();
      }
